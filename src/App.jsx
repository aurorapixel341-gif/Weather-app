...
function App() {
  ...
  const handleCurrentLocation = ({ lat, lon }) => {
    ...
    fetch(reverseGeocodeUrl)
      ...
      .catch((error) => console.error("Error fetching city from coordinates:", error));
  };
    ...
    <div>
      <Router>
        ...
        <Routes>
          ...
          />
          <Route exact path='/MapService' element={<Map initialCity={searchCity} />}/>
          <Route exact path='/AirQualityIndex' element={<AirQualityIndex/>}/>

          <Route exact path='/ClothingSuggestions' element={<ClothingSuggestions/>}/>
