...
const aqiLevels = [
  { max: 50, status: "Good", color: "#00E676", text: "Air quality is satisfactory, and air pollution poses little or no risk." },
  { max: 100, status: "Moderate", color: "#FFEB3B", text: "Air quality is acceptable; however, there may be a moderate health concern for sensitive people." },
  { max: 150, status: "Unhealthy for Sensitive Groups", color: "#FF9800", text: "Sensitive groups may experience health effects; others are less likely to be affected." },
  { max: 200, status: "Unhealthy", color: "#F44336", text: "Everyone may begin to experience health effects; sensitive groups may experience more serious effects." },
  { max: 300, status: "Very Unhealthy", color: "#9C27B0", text: "Health warnings of emergency conditions. The entire population is more likely to be affected." },
  { max: 500, status: "Hazardous", color: "#B71C1C", text: "Health alert: everyone may experience serious health effects." },
];
  ...
  return (
    <div className="weather-container" style={styles.container}>
      ...
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>Check your city’s air quality and plan your day with confidence.</p>
          ...
          <>
            <div style={styles.resultBox}>
              ...
              <div
                style={{
                  ...styles.aqiCircle,
                  background: "linear-gradient(135deg, ${aqiResult.color}, ${aqiResult.color}cc)",
