...
function ClothingSuggestions() {
  ...
  const getWeather = async () => {
    // ⚠ CRITICAL FIX: Check if the API key is the placeholder
    if (apiKey === "YOUR_API_KEY_HERE") {
      setSuggestion("⚠ Action Required: Please replace 'YOUR_API_KEY_HERE' in the code with your actual OpenWeatherMap API key for live data to work.");
      setWeather(null);
      return;
    }
...
`      );
  ...
  return (
    ...
    >
      <div
        style={{
  background: "linear-gradient(-135deg, #57769fff, #6b88b3, #8ca3c3, #a0b3cc, #a0b3cc, #c9d3dfff)",
          padding: "25px",
          borderRadius: "25px",
          width: "90%",
          maxWidth: "600px",
      ...
      >
        ...
        <p style={{ marginBottom: "25px", fontSize: "1.2rem", color: "#f0f0f0",             WebkitTextStroke: "0.3px rgba(0, 0, 0, 0.4)",
 }}>
          Enter your <b>city or country name</b> below to get outfit suggestions based on live weather!
        </p>
        ...
        boxShadow: "0 4px 15px rgba(0, 0, 0, 0.5)",
          ...
          >
            <h2 style={{ color: "white", textShadow: "0 0 5px rgba(59, 59, 59, 0.9)"}}>
              🌍 {weather.name}, {weather.sys.country}
            </h2>
            <p style={{color: "white", WebkitTextStroke: "0.3px rgba(0, 0, 0, 0.4)"}}>
