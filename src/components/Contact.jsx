  ...
  return (
    <div className="contact-container weather-container">
      ...
      <div className="tab-content">
        ...
        {active === "location" && (
          <div className="tab-pane weather-container" >
            <h2 style={{ display: "flex", gap: "10px", paddingBottom: "10px", paddingLeft: "10px" }}>
        ...
        {active === "socials" && (
          <div className="tab-pane weather-container">
            <h2 style={{ display: "flex", gap: "10px", paddingBottom: "10px", paddingLeft: "10px" }}>
              <FaGlobe style={{ color: "#c9c7c7ff" }} />{" "}
              Connect with Us
            </h2>
            <h3 style={{textAlign: "center", padding: "10px", fontSize: "30px"}}>Aurora Pixel</h3>
            <p style={{
            textAlign: "center",
            marginBottom: "20px",
            color: "white",
